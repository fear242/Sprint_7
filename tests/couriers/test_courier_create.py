...
class TestCourierCreation:
    ...
    @allure.title('Проверка регистрации курьера без указания логина')
    def test_register_courier_without_login(self, generate_and_return_login_password_without_registration):
